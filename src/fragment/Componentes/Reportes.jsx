...
import { Button } from 'reactstrap'; // Importamos Button de Reactstrap
import generatePdf  from './generatePdf' // Importamos la función para generar PDF
...
const Reportes = (props) => {
  ...
  return (
    <>
      {loading ? (
        <div className="row justify-content-center" style={{ padding: '100px', scale: '1' }}>
        ...
        <>
          <img src={'https://upload.wikimedia.org/wikipedia/commons/d/df/UNL3.png'} alt="404" style={{ width: '20%' }} />
          <h1 style={{ color: 'red', fontSize: '25px', fontFamily: 'Arial', fontWeight: '600' }}>{error}</h1>
        </>
      ) : (
        llDispositivos &&
        dispositivos.length > 0 && (
          <div className="row">
            <div className="col-6 " id="map-container">
              <MapView dispositivos={dispositivos} setSelectedUVData={setSelectedUVData} />
            </div>
            <div className="col-6">
              <MedicionView dispositivos={dispositivos} selectedUVData={selectedUVData} promedio={promedio} />
